...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', type=str, default = '/media/linger/udata/data_time/data/pm2/ir_vis', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--name', type=str, default='unet5_attention', help='name of the experiment. It decides where to store samples and models')
